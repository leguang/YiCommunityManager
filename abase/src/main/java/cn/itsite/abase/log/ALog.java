...
public final class ALog {
    private final String TAG = ALog.class.getSimpleName();
    ...
    private static final String TAG_DEFAULT = ALog.class.getSimpleName();
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at cn.itsite.abase.log.ALog")) {
                continue;
            }
